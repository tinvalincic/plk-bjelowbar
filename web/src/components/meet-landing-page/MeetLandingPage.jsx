...
import { Groups, Sponsors, RecordsTable } from "@/components";
...
export const LandingPage = ({
  ...
  recordsPot,
  totalPercentageMen,
  totalPercentageWomen,
  recordsPercentageMen,
  recordsPercentageWomen,
  recordsEndDate,
  meetName,
}) => {
      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <div className={classnames("container", styles.container)}>
            ...
            <div className={styles.fond}>{pot} €</div>
            <p>
          ...
          <div className="container">
            ...
            <ul>
              ...
              <li>
                ...
                minimalno {totalPercentageWomen}% svjetskog rekorda u totalu kod
                žena, odnosno {totalPercentageMen}% svjetskog rekorda u totalu
                kod muškaraca.
              </li>
            </ul>
            ...
            <div className={styles.recordsGrid}>
              <div>
                ...
                <RecordsTable
                  ...
                  qualifyingPercentage={recordsPercentageWomen / 100}
                  qualifyingTotalPercentage={totalPercentageWomen / 100}
                />
              </div>
              <div>
                ...
                <RecordsTable
                  records={recordsMen}
                  qualifyingPercentage={recordsPercentageMen / 100}
                  qualifyingTotalPercentage={totalPercentageMen / 100}
                />
              </div>
            </div>
